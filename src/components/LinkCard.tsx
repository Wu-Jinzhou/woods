...
export default function LinkCard({ link, onOpenNote, onDeleteLink, onDeleteNote, onMove, onRefetch }: LinkCardProps) {
  ...
  return (
    <div 
      className="group relative flex flex-col bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-zinc-800 overflow-hidden hover:shadow-md transition-all duration-200 h-full"
    >
      {/* Menu Button */}
      <div className="absolute top-2 right-2 z-20">
        <div className="relative">
          <button
            ...
            className="p-1.5 rounded-lg bg-white/80 dark:bg-black/50 backdrop-blur-sm text-gray-600 dark:text-gray-300 hover:bg-white dark:hover:bg-black hover:text-gray-900 dark:hover:text-white transition-colors opacity-0 group-hover:opacity-100 focus:opacity-100"
          >
